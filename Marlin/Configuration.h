...
#define STRING_CONFIG_H_AUTHOR "JEKim" // Who made the changes.
...
// #define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_Y_POINT ((X_BED_SIZE) / 2)  // Y point for Z homing
#endif
